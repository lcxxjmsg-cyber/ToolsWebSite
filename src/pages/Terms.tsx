...
const SECTIONS = [
  {
    ...
    title: '免费声明',
    content:
      '批图网是一款永久免费的图片处理工具。所有功能（包括但不限于格式转换、图片压缩、裁剪、滤镜、水印添加等）均对所有用户免费开放，无使用次数限制，无强制注册要求。我们承诺不会对任何现有免费功能收取费用。如果未来推出额外的高级功能，我们将通过明确的方式告知用户，且不会影响您已享有的免费功能。',
  },
  {
    icon: AlertTriangle,
    title: '免责声明',
  ...
  },
  {
    ...
    title: '知识产权',
    content:
      '批图网是一款免费工具，您可以自由使用所有功能。您使用本工具生成的图片内容和处理结果的知识产权完全属于您自己。我们不会对用户生成的内容主张任何权利。本工具使用到的第三方开源库的知识产权归各自作者所有。',
  },
  {
    icon: Clock,
    title: '服务可用性',
    content:
      '本工具基于静态网页技术，无需服务器端进行图片处理。但我们不承诺 100% 的服务可用性，也不保证在所有浏览器和所有设备上都能完美运行。以下情况可能导致服务中断或异常：您的网络连接问题、浏览器兼容性问题、设备性能不足、CDN 或托管服务的故障。我们会在力所能及的范围内尽快解决影响用户体验的问题。',
  },
  {
    icon: FileText,
    title: '条款修改',
...
export default function Terms() {
  useSEO({
    title: '使用条款 - 批图网 | 免费图片处理工具使用协议',
    description: '批图网使用条款：永久免费声明、免责声明、禁止用途、知识产权、服务可用性说明。纯本地图片处理，无隐藏费用。',
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0f0f0f]">
      <InjectJSONLD data={{
        ...
        '@type': 'WebPage',
        'name': '使用条款 - 批图网',
        'description': '批图网使用条款：永久免费声明及免责条款。',
        ...
        <article className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <div className="card p-6 sm:p-8 mb-8">
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              欢迎使用批图网。请在使用本工具前仔细阅读以下使用条款。访问或使用本工具即表示您同意遵守本条款的约束。如果您不同意本条款的任何部分，请停止使用本工具。
            </p>
          </div>
